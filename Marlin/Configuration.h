 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT 4 //WIFI is used for UART mod
 ...
 * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 -1 //MicroUSB
...
#define Z_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. true reports default open on BX
...
#define Z_MIN_PROBE_ENDSTOP_INVERTING false // Set to true to invert the logic of the probe. false reports default open on BX
